...
public class Week_exp extends Fragment {

    private RecyclerView exp;
    private DatabaseReference mExp;
    private HashMap<String,Integer> h=new HashMap<>();

    private int prevd = 0,tdays=0,newd,newm1,newm2,newm3,newy1,newy2,m,da,y;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        View mview= inflater.inflate(R.layout.activity_week_exp,container,false);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter=new FirebaseRecyclerAdapter<Data, MyViewHolder>(
            ...
            protected void populateViewHolder(MyViewHolder viewHolder, Data model, int i)
            {
                ...
                if(((cd>=newd && cd<=da) || ((cd>=prevd && cd <=tdays) || (cd>=1 && cd<=da) )) || ((cd>=prevd && cm==newm2 && cy==newy1) || (cd<=da &&cm==m && cy==y)))
                {
